  ...
  public render() {
    return (
      <div className="BetaExplanation">
        We're in open beta right now! That means that we hope you enjoy the
        ...
        for improving it! But also, please expect the unfortunate bug, and use
        the{" "}
        <a href={CONFIG_BUG_REPORT_FORM_LINK} target="_blank">
          <img src={BugIcon} /> <span>bug report</span>
        </a>{" "}
        link to let us know! Also, expect updates frequently!
      </div>
    );
  }
}
