  ...
  return (
    <>
      <p>
        ...
        would be used primarily to count individual books within a continuation
        — be that a single story/collection split across multiple volumes, or a
        series (such as manga).
        <sup id="fnref-1">
        ...
        would therefore be limited to when you are counting things from the same
        continuation, but wouldn't be used to count things from separate
        collections.
      </p>
      <p>
        <ruby>
