    ...
    return (
      <React.Fragment>
        <p>
          ...
          meaning "a battle." It's therefore easy to see that this counter will
          be used to count battles in a war.
        </p>
        <p>
          <ruby>
            戦<rp>(</rp>
          ...
          sees more limitations in terms of <em>which</em> sports or
          competitions it can be used for, making{" "}
          <ruby>
            戦<rp>(</rp>
            <rt>せん</rt>
            <rp>)</rp>
          ...
          <em>is</em> able to be used to count races (such as horse racing or
          auto racing), board-based games (such as Go or Shogi), or sporting
          competitions where participants don't directly interact but instead
          compete individually and win/lose via some proxy scoring (such as
          figure skating).
          <sup id="fnref-2">
          ...
          is not without its own limitations. At its core the kanji 戦 talks
          about warfare and conflict, fights where the whole purpose is to win;
          it can't be used to count exhibition matches, timed matches,
          practices, or other competitions where the goal of the encounter isn't
          to determine a winner/loser.
          <sup id="fnref-3">
        ...
        <p>
          The primary nuance with this counter is centered around that
          need-to-win aspect. While it isn't the case that choosing{" "}
          <ruby>
            試合<rp>(</rp>
            <rt>しあい</rt>
            <rp>)</rp>
