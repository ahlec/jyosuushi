  ...
  return (
    <>
      ...
      <p>
        ...
        with many native Japanese recalling memories of their grandparents born
        in the Meiji era (1868-1912) using みったり and よったり, among other
        now-defunct{" "}
        <ruby>
          和語<rp>(</rp>
          <rt>わご</rt>
        ...
        However, over time these native Japanese readings were replaced by their{" "}
        <ruby>
          漢語<rp>(</rp>
          <rt>かんご</rt>
          <rp>)</rp>
      ...
      <p>
        ...
        tongue-twister to say ひとたり. The sounds were simply blended together
        in order to make it easier to say when speaking.
        <sup id="fnref-4">
      ...
      <p>
        ...
        animals, with the intent of humanizing them (either out of respect or to
        highlight some human-like behaviour or appearance in the animal). Some
        people will count their pets with{" "}
        <ruby>
          人<rp>(</rp>
          <rt>にん</rt>
          <rp>)</rp>
...
export function Disambiguation名(): React.ReactElement {
  return (
    <p>
...
export function Disambiguation匹(): React.ReactElement {
  return (
    <p>
      While 人 is the counter for humans and 匹 is the counter for animals, the
      line can sometimes be blurred. Non-human animals can be counted with 人,
      either out of respect or love; using 人 to count an animal will humanize
      the animal. Conversely, humans can be counted with 匹 to emphasize
      animalistic behaviour; a woman counted with 匹 would carry the nuance of
      being more beast than man.
    </p>
  );
}
