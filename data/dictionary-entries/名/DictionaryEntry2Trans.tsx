...
class DictionaryEntry2Trans extends React.PureComponent<
  DictionaryEntryComponentProps
> {
  public render(): React.ReactNode {
    return <p>[Suffix] Counter. Used to count the number of people.</p>;
  }
}

export default DictionaryEntry2Trans;
